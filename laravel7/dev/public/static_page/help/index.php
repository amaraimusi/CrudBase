...
<div class="help_x">
	...
	<div id="help_x_div1">
		...
		<a href="#crudbase_help9_0" class="livipage btn btn-info btn-sm">削除した行を復元する（元に戻す）</a>
		...
		<a href="#crudbase_help9_3" class="livipage btn btn-info btn-sm">DBからも完全削除（抹消）</a>
	...
	<a href="#crudbase_help9_3" class="livipage">(参考：DBから完全削除)</a>
	<a href="#crudbase_help9_0" class="livipage">(参考：削除した行を復元する)</a>
	<br>
	...
	<div style="margin-left:20px;">
		<strong>初期戻し機能</strong>(検索状態をリセットする)<br>
		最初にページを開いた時の状態に戻す機能です。
		メイン検索のとなりにあるリセットボタンを押すと、検索されている状態や、一覧ソートされている状態をリセットして初期状態(検索前の状態）に戻すことができます。<br>
	</div><br>
	...
	<div id="crudbase_help13">
		...
		<br>
		画面上の一覧とはことなり行数制限の影響をうけません。
		画面上の一覧は検索結果数が多いと行数制限をかけ、すべての行を表示しないようにしていますが、
	...
	<div id="crudbase_help9_0">
		...
		詳細検索ボタンを押して詳細検索区画を開き、「有効/削除」のセレクトボックスを「削除」もしくは「すべて表示」に変更して検索を実行します。<br>
	...
	<div id="crudbase_help9_3">
		...
		削除状態の行を表示させるには、詳細検索から「有効/削除」のセレクトボックスを「削除」に切り替えて検索します。<br>
		すると、一覧の各行の最右側に「抹消」ボタンが表示されます。このボタンを押すとDBからも完全に消えます。<br>
		<br>
	</div><hr>
