...
class CrudBaseHelper {
	...
	private $strategy = null; // フレームワーク・ストラテジー
	private $param = null;
	...
	public function setParam(&$param){
		$this->param = $param;
		$this->strategy->setParam($param);
	}
	
	
	/**
	 * ヘルパーのフレームワーク・ストラテジーのセッター
	 * @param ICrudBaseHelper $strategy フレームワーク・ストラテジー
	 */
	public function setStrategy(ICrudBaseHelper $strategy){
		$this->strategy = $strategy;
	}
	
	/**
	 * CSSファイルの読み込み
	 * @param string $css_fp CSSファイルパス
	 */
	public function css($css_fp){
		$this->strategy->css($css_fp);
	}
	
	/**
	 * JSファイルの読み込み
	 * @param string $js_fp JavaScriptファイルパス
	 */
	public function js($js_fp){
		$this->strategy->js($js_fp);
	}
	...
	public function inputKjMain(&$kjs, $field, $wamei, $width=200, $title=null, $maxlength=255){
		...
		$this->strategy->inputKjMain($kjs, $field, $wamei, $width, $title, $maxlength);
	...
	public function inputKjText(&$kjs, $field, $wamei, $width=200, $title=null, $maxlength=255){
		...
		$this->strategy->inputKjText($kjs, $field, $wamei, $width, $title, $maxlength);
	...
	public function inputKjHidden(&$kjs, $field){
		$this->strategy->inputKjHidden($kjs, $field);
	...
	public function inputKjSelect(&$kjs, $field, $wamei, $list,$width=150, $title=null){
		...
		$this->strategy->inputKjSelect($kjs, $field, $wamei, $list,$width, $title);
	...
	public function inputKjDateTimeA(&$kjs, $field, $wamei, $list=[], $width=200, $title=null){
		...
		$this->strategy->inputKjDateTimeA($kjs, $field, $wamei, $list, $width, $title);
	...
	public function inputKjDeleteFlg(&$kjs){
		$this->strategy->inputKjDeleteFlg($kjs);
	...
	public function inputKjLimit(&$kjs){
		$this->strategy->inputKjLimit($kjs);
