...
define('CRUD_BASE_JS', '/CrudBase/dist/CrudBase/js/CrudBase/dist/CrudBase.min.js'); //
define('CRUD_BASE_CSS', '/CrudBase/dist/CrudBase/css/CrudBase/dist/CrudBase.min.css'); // 
